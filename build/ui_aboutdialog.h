...
"Copyright &copy; 2011-YYYY The Litecoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About UbuntuJobCredit", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>UbuntuJobCredit</b> version", Q_NULLPTR));
