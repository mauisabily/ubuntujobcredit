...
uint256 hashGenesisBlock("0x0d9e355b996a29bf2b0b5a1bd6e2cf981a6b04916c0a2dc4e26aa36d5955c0e4");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(503421396); // UbuntuJobCredit: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "UbuntuJobCredit Signed Message:\n";
...
{
    // UbuntuJobCredit: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 3600000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 30000); // UbuntuJobCredit: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // UbuntuJobCredit: 3.5 days
static const int64 nTargetSpacing = 150; // UbuntuJobCredit: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // UbuntuJobCredit: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // UbuntuJobCredit: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // UbuntuJobCredit: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbdc3d410308536b0a5b8d40c2b92927da0f8118ac4fd28a2cddb4e1e318ae16f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Testing Coin Made in Malaysia";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 3600000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("a9e18c018989a9b417d0af98ed5e92f74ede616337f2d0da2eb4773b3ff9caaf2ff0d2978e312b02931a890ee5ada237b73129d003c6167726be4987d706b110d7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1505925343;
        block.nBits    = 503421396;
        block.nNonce   = 3237798869;

        if (fTestNet)
        {
            block.nTime    = 1505925343;
            block.nNonce   = 1935074713;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb5b4c08606d5952fc2289c4a0e8fe6605fe432d63ceeb8e0537512b307d53386"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // UbuntuJobCredit: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("UbuntuJobCredit RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UbuntuJobCreditMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UbuntuJobCreditMiner : ProcessBlock, block not accepted");
    }
